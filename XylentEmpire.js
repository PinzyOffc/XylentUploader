...
if (global.maintenance && !isCreator) {
    if (isCmd && Date.now() - (_mc.get(m.sender) || 0) > 3600000) {
...
case 'nulis': {
    ...
    try {
        const response = await axios.get(
            `https://api.siputzx.my.id/api/tools/handwriting?text=${encodeURIComponent(text)}`,
        ...
        await reaction(m.chat, "❌");
        return m.reply('❌ Error, coba lagi nanti ya.');
    }
}
break;
//================================================================================
